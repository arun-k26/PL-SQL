/*
    What is Oracle Supplied Package?
        There are somany built-in package to solve frequent problem or the operation that we cant do with the existing plsql code.
        There are 1000+ built-in package in Oracle and going on.
        We can import external package and import that in out sql.
        
    DBMS_OUTPUT PACKAGE
        The dbms_output package provide the debugging and buffering of text data.
*/
